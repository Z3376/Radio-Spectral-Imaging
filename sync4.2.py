...
if(sys.argv[1]=='-d'):
	file_name_1	=	'raw_ch01_CASOBSTEST_20170301_143236_003.mbr'
	file_name_2	=	'raw_ch03_CASOBSTEST_20170301_143236_003.mbr'
	i_t			=	2
	n_s			=	1
	mode		=	2
else:
...
fig11	=	plt.figure(11)
plt.subplot(221)
plt.plot(np.real(mean(XX)))
plt.ylabel('XX')
plt.subplot(222)
plt.plot(np.real(mean(XY)))
plt.ylabel('XY')
plt.subplot(223)
plt.plot(np.real(mean(YX)))
plt.ylabel('YX')
plt.subplot(224)
plt.plot(np.real(mean(YY)))
plt.ylabel('YY')
...
fig21	=	plt.figure(21)
plt.subplot(221)
plt.imshow(np.real(XX),interpolation='bilinear',aspect='auto')
plt.ylabel('XX')
plt.subplot(222)
plt.imshow(np.real(XY),interpolation='bilinear',aspect='auto')
plt.ylabel('XY')
plt.subplot(223)
plt.imshow(np.real(YX),interpolation='bilinear',aspect='auto')
plt.ylabel('YX')
plt.subplot(224)
plt.imshow(np.real(YY),interpolation='bilinear',aspect='auto')
plt.ylabel('YY')
fig21.savefig(file_name_1[:-4]+'=X='+file_name_2[:-4]+'_im2(4.2).png')

fig3	=	plt.figure(3)
plt.subplot(221)
plt.plot(np.real(X_A1_m))
plt.ylabel('X_A1')
plt.subplot(222)
plt.plot(np.real(X_A2_m))
plt.ylabel('X_A2')
plt.subplot(223)
plt.plot(np.real(Y_A1_m))
plt.ylabel('Y_A1')
plt.subplot(224)
plt.plot(np.real(Y_A2_m))
plt.ylabel('Y_A2')
...
fig32	=	plt.figure(32)
plt.subplot(221)
plt.imshow(np.real(X_A1_m),interpolation='bilinear',aspect='auto')
plt.ylabel('X1')
plt.subplot(222)
plt.imshow(np.real(X_A2_m),interpolation='bilinear',aspect='auto')
plt.ylabel('X2')
plt.subplot(223)
plt.imshow(np.real(Y_A1_m),interpolation='bilinear',aspect='auto')
plt.ylabel('Y1')
plt.subplot(224)
plt.imshow(np.real(Y_A2_m),interpolation='bilinear',aspect='auto')
plt.ylabel('Y2')
...
fig12	=	plt.figure(12)
plt.subplot(221)
plt.plot(np.real(XX[1]))
plt.ylabel('XX')
plt.subplot(222)
plt.plot(np.real(XY[1]))
plt.ylabel('XY')
plt.subplot(223)
plt.plot(np.real(YX[1]))
plt.ylabel('YX')
plt.subplot(224)
plt.plot(np.real(YY[1]))
plt.ylabel('YY')

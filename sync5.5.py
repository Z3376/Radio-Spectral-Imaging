...
if(len(sys.argv)==2):
	if(sys.argv[1]=='-d'):
		file_name_1	=	'raw_ch07_CAS-A-TRNS_20170328_113518_000.mbr'
...
print 'Initial Synchronisation Done'
...
das_id_2	=	str(6)
src			=	'cas'
#das_id_1	=	file_name_1[8]
#das_id_2	=	file_name_2[8]
d_file_name	=	'0'
if(g_flag==0):
	if(not(isfile(file_name_1[:-8]+'_g_delay.txt'))):
		call(['./g_delay3.py',file_name_1[:-3]+'hdr',das_id_1,das_id_2,src])
	d_file_name	=	file_name_1[:-8]+'_g_delay.txt'
else:
	if(not(isfile(file_name_2[:-8]+'_g_delay.txt'))):
		call(['./g_delay3.py',file_name_2[:-3]+'hdr',das_id_1,das_id_2,src])

...
# Cross-correlation of two channels, of a particular das, in the same sniff file.
# Author: Harsh_Grover
...
z_t	=	Table(z)
z_t.write(file_name[:-8]+'_cross_corr.txt',format='ascii.no_header',overwrite='true')
...
plt.xlabel('Time(s)')
plt.ylabel('Frequency Channels')
fig2.savefig(file_name[:-4]+'real_cross_corr.png')
fig3=plt.figure(3)
